...
-git remote
git remote sirve para ver o administrar los repositorios remotos vinculados al proyecto.
Comandos útiles:
"git remote -v" muestra los repositorios remotos y sus direcciones.
"git remote add origin URL" agrega un repositorio remoto.

-git push
git push se usa para enviar nuestros commits al repositorio remoto.
Comandos útiles:
...
-git pull
git pull sirve para traer los cambios del repositorio remoto y actualizarlos en nuestra rama local.
Comandos útiles:
