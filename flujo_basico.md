...
## git add
El comando `git add`, mueve los cambios registrados por git al staged. 

* Si hacemos `git add .` se moveran todos los cambios al staged.
...
Es importante tener en cuenta que los commits representan una idea logica del cambio. Por lo que hay una convencion de como escribir los commits para que todo este ordenado y que transmita bien al resto del equipo el cambio realizado.
