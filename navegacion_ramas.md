...
git checkout
Sirve para moverte entre las ramas y tambien para posiciornanos en commit viejos o anteriores al que estamos.
    ...
    - git checkout hash, mueve el puntero HEAD al commit con el hash seleciconado.

git switch
Al igual que checkout, nos movemos entre las ramas, ocn la diferencia que switch lo tiene como funcion principal
    - git switch nombre rama, nos mueve a la rama
    - git -, nos regresa a la rama anterior en la que estabamos
